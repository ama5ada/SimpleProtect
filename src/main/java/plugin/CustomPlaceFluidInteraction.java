...
public class CustomPlaceFluidInteraction extends SimpleBlockInteraction {
    @Nonnull
    public static final BuilderCodec<CustomPlaceFluidInteraction> CODEC;
    @Nullable
    ...
    static {
        CODEC =
                BuilderCodec
                        .builder(
                                CustomPlaceFluidInteraction.class,
                                CustomPlaceFluidInteraction::new,
