...
public class PlaceBlockEventSystem extends EntityEventSystem<EntityStore, PlaceBlockEvent> {
    public PlaceBlockEventSystem(@Nonnull Class<PlaceBlockEvent> eventType) {
        super(eventType);
    }
    ...
    public void handle(int i, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk,
        ...
        if (ProtectionUtil.ShouldProtect(player, worldName, EVENT_TYPE.BLOCK_PLACE)) placeBlockEvent.setCancelled(true);
    }
